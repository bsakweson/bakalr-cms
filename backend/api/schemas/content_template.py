...
class ContentTemplateCreate(BaseModel):
    ...
    content_structure: Optional[Dict[str, Any]] = Field(None, description="Pre-filled content structure")
...
class ContentTemplateApply(BaseModel):
    ...
    overrides: Optional[Dict[str, Any]] = Field(None, description="Field values to override template defaults")
