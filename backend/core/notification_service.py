...
class NotificationService:
    ...
    @staticmethod
    def mark_all_as_read(db: Session, user_id: int, organization_id: int) -> int:
    ...
    def get_user_preference(
        db: Session, user_id: int, organization_id: int, event_type: str
...
async def notify_content_published(
    db: Session, user_id: int, organization_id: int, content_title: str, content_id: int
):
...
async def notify_media_uploaded(
    db: Session, user_id: int, organization_id: int, filename: str, media_id: int
):
...
async def notify_user_invited(
    db: Session, user_id: int, organization_id: int, inviter_name: str, organization_name: str
):
