    ...
    def get_endpoint_stats(self, endpoint: Optional[str] = None) -> Dict[str, Any]:
        ...
        if endpoint:
            ...
            return {
                ...
                "avg_time_ms": round((stats["total_time"] / stats["count"]) * 1000, 2) if stats["count"] > 0 else 0,
                ...
                "p95_time_ms": round(statistics.quantiles(times, n=20)[18] * 1000, 2) if len(times) >= 20 else 0,
                "p99_time_ms": round(statistics.quantiles(times, n=100)[98] * 1000, 2) if len(times) >= 100 else 0,
        ...
        return {
            ...
            for ep in self.endpoint_stats.keys()
        }
