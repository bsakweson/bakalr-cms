...
class Notification(Base):
    ...
    notification_type = Column(SQLEnum(NotificationType), nullable=False, default=NotificationType.INFO, index=True)
...
class NotificationPreference(Base):
    ...
    # Preference settings
    event_type = Column(String(100), nullable=False, index=True)  # "content.created", "media.uploaded", etc.
