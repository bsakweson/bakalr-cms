...
class Permission(Base, IDMixin, TimestampMixin):
    ...
    content_type_id = Column(Integer, ForeignKey("content_types.id", ondelete="CASCADE"), nullable=True, index=True)
    ...
    content_type = relationship("ContentType", backref="permissions", foreign_keys=[content_type_id])
