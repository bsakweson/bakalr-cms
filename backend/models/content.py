...
class ContentType(Base, IDMixin, TimestampMixin):
    ...
    entries = relationship("ContentEntry", back_populates="content_type", cascade="all, delete-orphan")
    templates = relationship("ContentTemplate", back_populates="content_type", cascade="all, delete-orphan")
...
class ContentEntry(Base, IDMixin, TimestampMixin):
    ...
    # Content Type
    content_type_id = Column(Integer, ForeignKey("content_types.id", ondelete="CASCADE"), nullable=False, index=True)
    ...
    translations = relationship("Translation", back_populates="content_entry", cascade="all, delete-orphan")
    schedules = relationship("ContentSchedule", back_populates="content_entry", cascade="all, delete-orphan")
