...
def upgrade():
    ...
    op.create_table('notifications',
        ...
        sa.Column('notification_type', sa.Enum('INFO', 'SUCCESS', 'WARNING', 'ERROR', 'CONTENT', 'MEDIA', 'USER', 'SYSTEM', name='notificationtype'), nullable=False),
    ...
    op.create_table('email_logs',
        ...
        sa.Column('status', sa.Enum('PENDING', 'SENDING', 'SENT', 'FAILED', 'BOUNCED', 'OPENED', 'CLICKED', name='emailstatus'), nullable=False),
