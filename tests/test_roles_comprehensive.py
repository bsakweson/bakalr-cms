...
class TestRolesComprehensive:
    ...
    def test_create_role_full_workflow(self, authenticated_client):
        ...
        role_response = authenticated_client.post(
            "/api/v1/roles", json={"name": "Content Editor", "description": "Can edit content"}
        )
    ...
    def test_role_update_logic(self, authenticated_client):
        ...
        create_response = authenticated_client.post(
            "/api/v1/roles", json={"name": "Test Role", "description": "Original description"}
        )
        ...
        if create_response.status_code == status.HTTP_201_CREATED:
            ...
            update_response = authenticated_client.put(
                ...
                json={"name": "Updated Role", "description": "Updated description"},
            )
    ...
    def test_permission_categories(self, authenticated_client):
        ...
        for category in categories:
            response = authenticated_client.get(f"/api/v1/roles/permissions?category={category}")
