...
def export_to_json(entries: List[ContentEntry], output_file: str, include_translations: bool = True):
...
def main():
    ...
    parser.add_argument(
        "--content-type",
        "-t",
        help="Filter by content type API ID (e.g., blog_post, page)"
    )
    parser.add_argument(
        "--organization",
    ...
    parser.add_argument(
        "--limit",
        type=int,
        help="Limit number of entries to export"
    )
