...
def migrate_database_products(
    client: httpx.Client, headers: dict, dry_run: bool = True, clean_legacy: bool = False
):
    ...
    for product in products:
        ...
        if dry_run:
            ...
            update_resp = client.patch(
                f"{API_URL}/content/entries/{product_id}", json={"data": new_data}, headers=headers
            )
