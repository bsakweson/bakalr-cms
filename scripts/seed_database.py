...
from backend.models.notification import Notification  # Import to register model
...
def create_default_roles(db: Session, permissions: dict[str, Permission], org: Organization) -> dict[str, Role]:
    ...
    roles_data = {
        ...
        "admin": {
            ...
            "permissions": [
                ...
                "content_type.read", "content_type.create", "content_type.update", "content_type.delete",
        ...
        "editor": {
            ...
            "permissions": [
                ...
                "translation.read", "translation.create", "translation.update"
            ]
        },
        "author": {
...
def create_sample_content_types(db: Session, org: Organization):
        ...
        },
        {
            ...
            "fields_schema": {
                "fields": [
                    ...
                    {"name": "meta_description", "type": "textarea", "required": False, "localized": True}
                ]
            }
        },
        {
    ...
    for ct_data in content_types_data:
        ct = db.query(ContentType).filter(
...
def main():
    ...
    try:
        ...
        print("=" * 60)
        print("\n📝 Admin Credentials:")
        print(f"   Email: admin@bakalr.cms")
